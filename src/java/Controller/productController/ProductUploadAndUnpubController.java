 ...
 * @author Pubudu Kasun
 */
@WebServlet(name = "ProductUploadAndUnpubController", urlPatterns = {"/ProductUploadAndUnpubController"})
public class ProductUploadAndUnpubController extends HttpServlet {
...
//                }
                ...
                pr.setPublishUnpublishId(Boolean.FALSE);
